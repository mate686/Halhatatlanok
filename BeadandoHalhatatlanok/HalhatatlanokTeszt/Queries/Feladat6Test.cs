    ...
    public class Feladat6Test
    {
        ...
        public void Feladat6_Teszt()
        {
            ...
            context.Tagok.AddRange(
                new Tagok { Nev = "Zenthe Ferenc", Ev = 1960, Kategoria = szinesz },
                new Tagok { Nev = "Bodrogi Gyula", Ev = 1960, Kategoria = szinesz },
                new Tagok { Nev = "Latinovits Zoltán", Ev = 1970, Kategoria = szinesz }
            );
